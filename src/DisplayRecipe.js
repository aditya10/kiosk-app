      ...
      <div className='app'>
        <div className='container'>
          <section className='display-recipe col-md-8 col-sm-12'>
                ...
                <div className="imgDiv"><img alt="" className="image" src={this.state.imgLink} /></div>
                <h2>Ingredients</h2>
                ...
                <div className="recipeLink"><a className="link" href={this.state.recipeLink}>Click Here 🍴</a></div>
